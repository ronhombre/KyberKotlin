...
class Tests {
    ...
    fun katTest512() {
        ...
        val key = KyberKeyPairGenerator.generate(KyberParameter.ML_KEM_512, randomSeed, pkeSeed)
        ...
        assertEquals(knownEncapsulationKey, key.encapsulationKey.toHex(), "Encapsulation key is not correct!")
        assertEquals(knownDecapsulationKey, key.decapsulationKey.toHex(), "Decapsulation key is not correct!")
    }
    ...
    fun katTest768() {
        ...
        val key = KyberKeyPairGenerator.generate(KyberParameter.ML_KEM_768, randomSeed, pkeSeed)
    ...
    fun katTest1024() {
        ...
        val key = KyberKeyPairGenerator.generate(KyberParameter.ML_KEM_1024, randomSeed, pkeSeed)
